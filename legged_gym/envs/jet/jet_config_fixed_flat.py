...
###########CENTROIDAL################
class JetFlatCfg_fixed_centroid( LeggedRobotCfg ):
    class env( LeggedRobotCfg.env):
        num_envs = 4096
        num_observations = 51 # 169 + 16*3
        num_actions = 13 # 12(lower) + 16(upper)
    ...
    class asset( LeggedRobotCfg.asset ):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/jet/urdf/jet_fixed_centroid.urdf'
        name = "jet_fixed"
        foot_name = 'AnkleRoll'
        terminate_after_contacts_on = ['Hip', 'Waist', 'Knee', 'base'] # check legged_robot.py->_create_envs->uses links of which names contain "terminate_after_contacts_on"
        flip_visual_attachments = False
...
class JetFlatCfgPPOSym_fixed( LeggedRobotCfgPPOSym):
    
    class runner( LeggedRobotCfgPPOSym.runner ):
        run_name = ''
        experiment_name = 'flat_jet_fixed_sym'
...
class JetFlatCfgPPOSym_fixed_centroid( LeggedRobotCfgPPOSym):
    
    class runner( LeggedRobotCfgPPOSym.runner ):
        run_name = ''
        experiment_name = 'flat_jet_fixed_sym_centroid'
