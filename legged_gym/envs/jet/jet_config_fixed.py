...
class JetRoughCfg_fixed( LeggedRobotCfg ):
    class env( LeggedRobotCfg.env):
        num_envs = 2048
        num_observations = 169 # 169 + 16*3
    ...
    class rewards( LeggedRobotCfg.rewards ):
        soft_dof_pos_limit = 0 #0.95
        soft_dof_vel_limit = 0 #0.9
        soft_torque_limit = 0 #0.9
...
class JetRoughCfgPPO_fixed( LeggedRobotCfgPPO):
    
    class runner( LeggedRobotCfgPPO.runner ):
        run_name = ''
        experiment_name = 'rough_jet_fixed'
